...
from .models import Author, Book, Docservice, ServiceType, Issue
...
class DocserviceAdmin(admin.ModelAdmin):
    list_display = ("type",)
    search_fields = ["type"]
    # inlines = [
    #     BookInline,
...
# @admin.register(Docservice)
admin.site.register(Docservice)


class Docservice(admin.ModelAdmin):
